...
namespace CURDOperation.Controllers
{
    ...
    {
        private readonly CURDOperationContext _context;

        public SpeakersController(CURDOperationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SpeakerName,Qualification,Experience,SpeakingDate,SpeakingTime,Venue,ProfilePicture")] Speaker speaker)
        {
